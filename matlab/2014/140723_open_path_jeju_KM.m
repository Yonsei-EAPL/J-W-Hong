...
%% load input data
dataDir = 'D:\EAPL_keun\_EAPL_Observation\а╕аж\Obs_Data\Raw_Data\CSV_jeju'; % folder name
...
%    result(i,46)=skewness(temp(:,1)); % result : skewness of v
%    result(i,50)=kurtosis(temp(:,1)); % result : kurtosis of v
%    result(i,47)=skewness(temp(:,1)); % result : skewness of w
%    result(i,51)=kurtosis(temp(:,1)); % result : kurtosis of w    
