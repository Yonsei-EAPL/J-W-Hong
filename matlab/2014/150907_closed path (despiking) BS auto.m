...
% before 2015-07-10 11:28 @ 60m
% po_u = 7;
% po_v = 8;
% po_w = 9;
% po_Ts = 10;
% po_diag1 = 11; %% 2015-06-05
% po_CO2 = 12;
% po_H2O = 13;
% po_diag2 = 14; %% 2015-06-05
% po_cell_prs = 16;
% po_diff_prs = 17;

% after 2015-07-10 11:28 @ 60m
po_u = 5;
po_v = 6;
po_w = 7;
po_Ts = 8;
...
dataName = dir(fullfile(dataDir, 'CSV_8970.ts_data_60m*'))'; 
...
%                 end
%             end
%             if (temp_diag_n1>0)&&(temp_diag_n1<36000)
%                 for j = 1:36000
%                     if temp(j,9)~=0
%                         if j==1
...
%                 end
%             end
%             if (temp_diag_n2>0)&&(temp_diag_n2<36000)
%                 for j = 1:36000
%                     if temp(i,10)~=0
%                         if j==1
