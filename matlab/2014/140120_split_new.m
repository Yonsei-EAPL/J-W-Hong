...
% 3. change year (ex 2003-> your yr)


%% split 2003 (new version)
size = 3711260; % 03
% size = 3747929; % 04
% size = 3760382 % 05
% size = 3848414 % 09
...
for i = 2:size
   for j = 5:8
        temp1 = data{i,1}(1,j);
        aws2003(i-1,j+4) = str2num(temp1{1,1});
   end
   temp1 = regexp(data{i,1}{1,1},'	','split'); 
   aws2003(i-1,1) = str2num(temp1{1,1});
   aws2003(i-1,2) = str2num(temp1{1,2});
   
   temp1 = regexp(data{i,1}{1,3},'	','split'); 
   aws2003(i-1,3) = str2num(temp1{1,2});
   aws2003(i-1,4) = str2num(temp1{1,3});
   
   temp1 = regexp(data{i,1}{1,4},' ','split');
   aws2003(i-1,8) = str2num(temp1{1,2});
   temp2 = regexp(temp1{1,1},'-','split');
   aws2003(i-1,5) = str2num(temp2{1,1});
   aws2003(i-1,6) = str2num(temp2{1,2});
   aws2003(i-1,7) = str2num(temp2{1,3});
end
i2 = i;
i2
...
for i = 1:size-1
    if temp ~= aws2003(i,2) % changes in stn_id
        temp = aws2003(i,2);
        temp1 = temp1 + 1;
        temp2_2 = aws2003(i,7);
        GEV(temp1,1) = temp1;
    ...
    if temp2_2 ~= aws2003(i,7) % changes in day within same stn_id
        temp2_2 = aws2003(i,7);
        if temp2_3 > temp2_4
            temp2_4 = temp2_3;
        end
        temp2_3 = aws2003(i,10);
    ...
    if aws2003(i,10)>0 && aws2003(i,10)<3000
        temp2_3 = temp2_3 + aws2003(i,10);
        for j = 1:5
            temp3_2(j,1) = temp3_2(j,1) + aws2003(i,10);
        end
    end
