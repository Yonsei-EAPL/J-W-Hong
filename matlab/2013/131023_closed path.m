...
% 131023 Mr.Je-Woo Hong; Modify equation, Remove WPL(Closed-path).
...
for i = 1:max(num_30min_n(:,1))
    ...
    for j = 1:num_30min_n(i,2)
        ...
        if abs(mean_wd-temp_wd)>180
            if (mean_wd-temp_wd)<0
                ...
                temp_std_wd = temp_std_wd + (360 - mean_wd+temp_wd)^2; % JY 2017-Nov.
            end
        else
    ...
    result(i,26)= alpha; % 140319 - for rotated angle
    result(i,27)= beta; % 140319 - for rotated angle
