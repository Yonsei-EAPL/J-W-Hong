...
%% result
result = zeros(max(num_30min_n(:,1)),219);
% 1; n_data (unitless)
...
jw_co = zeros(48,48);
for jewoo = 1:48%49:96
    
    for i = jewoo:jewoo%1:max(num_30min_n(:,1))
